...
const tokenInfo = {
  moonboy: {
    ...
    set: 2,
    external_url: "https://moonheads.io",
    supply: 10,
    start: 14000000,
    created: 1620748309,
    limited: true,
  ...
  sleeve: {
    name: "Sleeve",
    description:
      "Use this to protect your MoonHead's condition. Every time you transfer a MoonHead without a sleeve, the card will become a little more damaged. Apply the sleeves on moonheads.io",
    set: 0,
    external_url: "https://moonheads.io",
    supply: 1,
    start: 1,
